...
export default function Login(props: PageProps<Extract<KcContext, { pageId: "login.ftl" }>, I18n>) {
    ...
    return (
        <>
            ...
            <div style={{ boxShadow: "none", marginTop: "10px" }}>
                <Template
                    kcContext={kcContext}
                    i18n={i18nProps}
                    ...
                    headerNode={<span style={{ fontWeight: 500, fontSize: "30px" }}>{t("signInTitle")}</span>}
                ...
                >
                    <div id="kc-form" style={{ display: "flex", justifyContent: "center" }}>
                        <div id="kc-form-wrapper" style={{ width: "100%", maxWidth: "600px", padding: "0 20px" }}>
                            {realm.password && (
                                <form
                                    id="kc-form-login"
                                    onSubmit={() => {
                                    ...
                                    <div className={kcClsx("kcFormGroupClass")}>
                                        <div style={{ display: "flex", justifyContent: "center" }}>
                                            <FormControl
                                                ...
                                                error={messagesPerField.existsError("username", "password")}
                                            >
                                                <span style={{ fontSize: "20px" }}>{t("password")}</span>
                                    ...
                                    >
                                        ...
                                        <Button
                                            ...
                                            sx={{
                                                ...
                                                fontWeight: 700,
                                                "&:hover": {
                                                    backgroundColor: "rgba(255, 189, 48, 0.8)",
                                                    boxShadow: "none"
                                                }
                                            }}
                                        >
